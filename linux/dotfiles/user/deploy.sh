...
main(){
    ...
    # code-oss
    deploy '.config/Code - OSS/User/settings.json' "${HOME}/.config/Code/User/settings.json"

    # sublime
    #deploy '.config/sublime-text/Packages/User/Preferences.sublime-settings' "${HOME}/.config/sublime-text/Packages/User/Preferences.sublime-settings"
}
